...
#define __count_args(...) ___count_args(__VA_ARGS__, 7, 6, 5, 4, 3, 2, 1, 0)

#define __constraint_write_0 "+r"(r0), "=&r"(r1), "=&r"(r2), "=&r"(r3)
#define __constraint_write_1 "+r"(r0), "+r"(r1), "=&r"(r2), "=&r"(r3)
#define __constraint_write_2 "+r"(r0), "+r"(r1), "+r"(r2), "=&r"(r3)
#define __constraint_write_3 "+r"(r0), "+r"(r1), "+r"(r2), "+r"(r3)
...
#define __arm_smccc_1_1(inst, ...)                                    \
  do {                                                                \
    ...
    if (___res) *___res = (typeof(*___res)){r0, r1, r2, r3};          \
  } while (0)
